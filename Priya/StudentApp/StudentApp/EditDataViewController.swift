...
//        let listVc = self.navigationController?.viewControllers[0] as! ViewController
        ...
        let data = UserDefaults.standard.value(forKey: "student") as? Data
        ...
        if data == nil {
            ...
            arrStuData = (NSKeyedUnarchiver.unarchiveObject(with:data!) as! Array<Student>?)!
            arrStuData.append(stu)
        }
        
        UserDefaults.standard.set(NSKeyedArchiver.archivedData(withRootObject: arrStuData), forKey: "student")
